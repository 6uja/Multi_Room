# Java 기반 멀티룸 채팅 서버 및 TCP/IP 프로토콜 설계 프로젝트

## 프로젝트 소개

Java Socket과 TCP/IP 통신을 활용하여 여러 사용자가 동시에 접속 가능한
멀티룸 채팅 서버를 구현한 프로젝트입니다.

사용자는 닉네임을 통해 로그인하고,
원하는 채팅방을 생성 및 이동할 수 있으며,
귓속말, 접속자 목록 조회, 채팅방 목록 조회 등의 기능을 사용할 수 있습니다.
